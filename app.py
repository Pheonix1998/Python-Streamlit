...
@st.cache_data
def load_data():
    data_path = os.path.join("data", "E:\\New folder\\TOTAL POLICY DETAILS.csv")
...
def load_model():
    ...
    if not os.path.exists(model_path):
        st.error("Model file missing. Train model before deployment.")
        st.stop()
...
st.caption("Random Forest–based pricing intelligence")
